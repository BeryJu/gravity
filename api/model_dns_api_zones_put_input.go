...
type _DnsAPIZonesPutInput DnsAPIZonesPutInput
...
func (o *DnsAPIZonesPutInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsAPIZonesPutInput := _DnsAPIZonesPutInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDnsAPIZonesPutInput)

	if err != nil {
		return err
	}

	*o = DnsAPIZonesPutInput(varDnsAPIZonesPutInput)
