...
type _DiscoveryAPIRoleConfigInput DiscoveryAPIRoleConfigInput
...
func (o *DiscoveryAPIRoleConfigInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDiscoveryAPIRoleConfigInput := _DiscoveryAPIRoleConfigInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDiscoveryAPIRoleConfigInput)

	if err != nil {
		return err
	}

	*o = DiscoveryAPIRoleConfigInput(varDiscoveryAPIRoleConfigInput)
