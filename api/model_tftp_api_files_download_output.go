...
type _TftpAPIFilesDownloadOutput TftpAPIFilesDownloadOutput
...
func (o *TftpAPIFilesDownloadOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varTftpAPIFilesDownloadOutput := _TftpAPIFilesDownloadOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTftpAPIFilesDownloadOutput)

	if err != nil {
		return err
	}

	*o = TftpAPIFilesDownloadOutput(varTftpAPIFilesDownloadOutput)
