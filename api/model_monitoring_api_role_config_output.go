...
type _MonitoringAPIRoleConfigOutput MonitoringAPIRoleConfigOutput
...
func (o *MonitoringAPIRoleConfigOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoringAPIRoleConfigOutput := _MonitoringAPIRoleConfigOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonitoringAPIRoleConfigOutput)

	if err != nil {
		return err
	}

	*o = MonitoringAPIRoleConfigOutput(varMonitoringAPIRoleConfigOutput)
