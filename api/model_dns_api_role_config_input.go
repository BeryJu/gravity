...
type _DnsAPIRoleConfigInput DnsAPIRoleConfigInput
...
func (o *DnsAPIRoleConfigInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsAPIRoleConfigInput := _DnsAPIRoleConfigInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDnsAPIRoleConfigInput)

	if err != nil {
		return err
	}

	*o = DnsAPIRoleConfigInput(varDnsAPIRoleConfigInput)
