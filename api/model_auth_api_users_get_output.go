...
type _AuthAPIUsersGetOutput AuthAPIUsersGetOutput
...
func (o *AuthAPIUsersGetOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthAPIUsersGetOutput := _AuthAPIUsersGetOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthAPIUsersGetOutput)

	if err != nil {
		return err
	}

	*o = AuthAPIUsersGetOutput(varAuthAPIUsersGetOutput)
