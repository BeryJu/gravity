...
type _BackupAPIRoleConfigOutput BackupAPIRoleConfigOutput
...
func (o *BackupAPIRoleConfigOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupAPIRoleConfigOutput := _BackupAPIRoleConfigOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupAPIRoleConfigOutput)

	if err != nil {
		return err
	}

	*o = BackupAPIRoleConfigOutput(varBackupAPIRoleConfigOutput)
