...
type _BackupBackupStatus BackupBackupStatus
...
func (o *BackupBackupStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupBackupStatus := _BackupBackupStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupBackupStatus)

	if err != nil {
		return err
	}

	*o = BackupBackupStatus(varBackupBackupStatus)
