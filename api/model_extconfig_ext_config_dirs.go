...
type ExtconfigExtConfigDirs struct {
	...
	TftpLocalDir *string `json:"tftpLocalDir,omitempty"`
}
...
func (o *ExtconfigExtConfigDirs) GetTftpLocalDir() string {
	if o == nil || IsNil(o.TftpLocalDir) {
		var ret string
		return ret
	}
	return *o.TftpLocalDir
}

// GetTftpLocalDirOk returns a tuple with the TftpLocalDir field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExtconfigExtConfigDirs) GetTftpLocalDirOk() (*string, bool) {
	if o == nil || IsNil(o.TftpLocalDir) {
		return nil, false
	}
	return o.TftpLocalDir, true
}
...
func (o ExtconfigExtConfigDirs) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TftpLocalDir) {
		toSerialize["tftpLocalDir"] = o.TftpLocalDir
	}
