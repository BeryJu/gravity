...
func (r ApiDnsImportZonesRequest) Zone(zone string) ApiDnsImportZonesRequest {
	r.zone = &zone
	return r
}

func (r ApiDnsImportZonesRequest) DnsAPIZonesImportInput(dnsAPIZonesImportInput DnsAPIZonesImportInput) ApiDnsImportZonesRequest {
	r.dnsAPIZonesImportInput = &dnsAPIZonesImportInput
	return r
}

func (r ApiDnsImportZonesRequest) Execute() (*DnsAPIZonesImportOutput, *http.Response, error) {
	return r.ApiService.DnsImportZonesExecute(r)
}

/*
DnsImportZones DNS Zones
...
func (a *RolesDnsApiService) DnsImportZonesExecute(r ApiDnsImportZonesRequest) (*DnsAPIZonesImportOutput, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/dns/zones/import"
	...
	// body params
	localVarPostBody = r.dnsAPIZonesImportInput
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
