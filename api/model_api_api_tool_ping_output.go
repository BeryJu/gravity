...
type ApiAPIToolPingOutput struct {
	AvgRtt                interface{} `json:"avgRtt,omitempty"`
	MaxRtt                interface{} `json:"maxRtt,omitempty"`
	...
	StdDevRtt             interface{} `json:"stdDevRtt,omitempty"`
}
...
// GetAvgRtt returns the AvgRtt field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetAvgRtt gets a reference to the given interface{} and assigns it to the AvgRtt field.
func (o *ApiAPIToolPingOutput) SetAvgRtt(v interface{}) {
	o.AvgRtt = v
}

// GetMaxRtt returns the MaxRtt field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetMaxRtt gets a reference to the given interface{} and assigns it to the MaxRtt field.
...
// GetStdDevRtt returns the StdDevRtt field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetStdDevRtt gets a reference to the given interface{} and assigns it to the StdDevRtt field.
