...
type _DiscoveryAPIRoleConfigOutput DiscoveryAPIRoleConfigOutput
...
func (o *DiscoveryAPIRoleConfigOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varDiscoveryAPIRoleConfigOutput := _DiscoveryAPIRoleConfigOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDiscoveryAPIRoleConfigOutput)

	if err != nil {
		return err
	}

	*o = DiscoveryAPIRoleConfigOutput(varDiscoveryAPIRoleConfigOutput)
