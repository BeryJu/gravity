...
type _ApiAPIRoleConfigOutput ApiAPIRoleConfigOutput
...
func (o *ApiAPIRoleConfigOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varApiAPIRoleConfigOutput := _ApiAPIRoleConfigOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiAPIRoleConfigOutput)

	if err != nil {
		return err
	}

	*o = ApiAPIRoleConfigOutput(varApiAPIRoleConfigOutput)
