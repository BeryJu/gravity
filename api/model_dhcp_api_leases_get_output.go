...
type _DhcpAPILeasesGetOutput DhcpAPILeasesGetOutput
...
func (o *DhcpAPILeasesGetOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varDhcpAPILeasesGetOutput := _DhcpAPILeasesGetOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDhcpAPILeasesGetOutput)

	if err != nil {
		return err
	}

	*o = DhcpAPILeasesGetOutput(varDhcpAPILeasesGetOutput)
