...
func (o *DnsAPIZone) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsAPIZone := _DnsAPIZone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDnsAPIZone)

	if err != nil {
		return err
	}

	*o = DnsAPIZone(varDnsAPIZone)
