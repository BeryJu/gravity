...
type _BackupAPIBackupStatusOutput BackupAPIBackupStatusOutput
...
func (o *BackupAPIBackupStatusOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupAPIBackupStatusOutput := _BackupAPIBackupStatusOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupAPIBackupStatusOutput)

	if err != nil {
		return err
	}

	*o = BackupAPIBackupStatusOutput(varBackupAPIBackupStatusOutput)
