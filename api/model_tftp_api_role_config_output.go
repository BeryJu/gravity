...
type _TftpAPIRoleConfigOutput TftpAPIRoleConfigOutput
...
func (o *TftpAPIRoleConfigOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varTftpAPIRoleConfigOutput := _TftpAPIRoleConfigOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTftpAPIRoleConfigOutput)

	if err != nil {
		return err
	}

	*o = TftpAPIRoleConfigOutput(varTftpAPIRoleConfigOutput)
