...
func (r ApiDhcpImportScopesRequest) DhcpAPIScopesImportInput(dhcpAPIScopesImportInput DhcpAPIScopesImportInput) ApiDhcpImportScopesRequest {
	r.dhcpAPIScopesImportInput = &dhcpAPIScopesImportInput
	return r
}

func (r ApiDhcpImportScopesRequest) Execute() (*DhcpAPIScopesImportOutput, *http.Response, error) {
	return r.ApiService.DhcpImportScopesExecute(r)
}

/*
DhcpImportScopes DHCP Scopes
...
func (a *RolesDhcpAPIService) DhcpImportScopesExecute(r ApiDhcpImportScopesRequest) (*DhcpAPIScopesImportOutput, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/dhcp/scopes/import"
	...
	// body params
	localVarPostBody = r.dhcpAPIScopesImportInput
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
