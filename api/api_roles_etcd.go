...
type ApiEtcdMoveLeaderRequest struct {
	ctx        context.Context
	ApiService *RolesEtcdAPIService
	peerID     *string
}

func (r ApiEtcdMoveLeaderRequest) PeerID(peerID string) ApiEtcdMoveLeaderRequest {
	r.peerID = &peerID
	return r
}

func (r ApiEtcdMoveLeaderRequest) Execute() (*http.Response, error) {
	return r.ApiService.EtcdMoveLeaderExecute(r)
}

/*
EtcdMoveLeader Etcd move leader

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiEtcdMoveLeaderRequest
*/
func (a *RolesEtcdAPIService) EtcdMoveLeader(ctx context.Context) ApiEtcdMoveLeaderRequest {
	return ApiEtcdMoveLeaderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *RolesEtcdAPIService) EtcdMoveLeaderExecute(r ApiEtcdMoveLeaderRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RolesEtcdAPIService.EtcdMoveLeader")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/etcd/move_leader"
