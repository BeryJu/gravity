    ...
    render(): TemplateResult {
        ...
        return html`<section class="pf-v6-c-page__main-section">
            <div class="pf-v6-l-grid pf-m-gutter">
                ...
                <div
                    class="pf-v6-l-grid__item pf-m-12-col pf-m-9-col-on-xl pf-m-9-col-on-2xl big-graph-container"
                >
                    <ak-aggregate-card
                ...
                <div
                    class="pf-v6-l-grid__item pf-m-12-col pf-m-3-col-on-xl pf-m-3-col-on-2xl big-graph-container"
                >
