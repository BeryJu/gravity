...
export class ActionWizardPage extends WizardPage {
    ...
    @property({ attribute: false })
    currentStep: ActionStateBundle | undefined;
        ...
        return html`<div class="pf-v6-l-bullseye">
            <div class="pf-v6-c-empty-state pf-m-lg">
                <div class="pf-v6-c-empty-state__content">
                    <i class="fas fa-cogs pf-v6-c-empty-state__icon" aria-hidden="true"></i>
                    ...
                    <div class="pf-v6-c-empty-state__body">
                        <ol class="pf-v6-c-progress-stepper pf-m-vertical">
                            ${this.states.map((state) => {
                                ...
                                return html` <li class="pf-v6-c-progress-stepper__step ${cls}">
