...
func (ro *APIServerRole) handleAPIGet(rw http.ResponseWriter, r *http.Request) {
...
func (ro *APIServerRole) handleAPIPost(rw http.ResponseWriter, r *http.Request) {
...
func (ro *APIServerRole) handleAPIDel(rw http.ResponseWriter, r *http.Request) {
