...
require (
	github.com/0xERR0R/blocky v0.29.0
	...
	github.com/k8s-gateway/k8s_gateway v1.7.1
...
require (
	...
	github.com/jedisct1/go-dnsstamps v0.0.0-20251110100135-9130479da135 // indirect
